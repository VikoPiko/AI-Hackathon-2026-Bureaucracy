...
export const TRANSLATIONS: Record<Language, TranslationTree> = {
  ...
  bg: {
    ...
    askPage: {
      ...
      temporaryChatShort: "Временен",
      temporaryEnabled: "Временният чат е активиран",
      temporaryEnabledBody: "Съобщенията в този разговор няма да бъдат запазени.",
      loadedFromHistory: "Зареждане от историята",
      loadedFromHistoryBody: "Можеш да продължиш този разговор или да зададеш допълнителен въпрос.",
      continuingFromHistory: "Продължение на въпроса от историята",
    },
    answerDisplay: {
      verified: "Проверено",
  ...
  de: {
    ...
    askPage: {
      ...
      temporaryEnabledBody: "Nachrichten in diesem Gespräch bleiben nur auf diesem Bildschirm.",
      loadedFromHistory: "Aus Verlauf geladen",
      loadedFromHistoryBody: "Du kannst dieses Gespräch fortsetzen oder eine Folgefrage stellen.",
