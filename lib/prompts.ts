...
/**
 * Build system prompt for chat Q&A
 */
...
/**
 * Build system prompt for relocation journey
 */
export function buildJourneySystemPrompt(toCountry: string): string {
...
/**
 * Build system prompt for country comparison
 */
